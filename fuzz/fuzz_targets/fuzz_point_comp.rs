...
use pasetors::keys::*;
use ring::signature::{UnparsedPublicKey, KeyPair, EcdsaKeyPair, ECDSA_P384_SHA384_FIXED, ECDSA_P384_SHA384_FIXED_SIGNING};
use core::convert::TryFrom;

fuzz_target!(|data: &[u8]| {
    let rng = ring::rand::SystemRandom::new();
    let pkcs8_bytes = EcdsaKeyPair::generate_pkcs8(&ECDSA_P384_SHA384_FIXED_SIGNING, &rng).unwrap();
    let key_pair = EcdsaKeyPair::from_pkcs8(&ECDSA_P384_SHA384_FIXED_SIGNING, pkcs8_bytes.as_ref()).unwrap();
